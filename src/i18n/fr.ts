...
export const fr = {
  ...
  'decks.section.legend': 'Par légende',
  ...
  'settings.legendThreshold': 'Seuil de présence par légende',
  'settings.legendThresholdValue': '≥ {threshold} %',
  'settings.legendThresholdHelp': 'Une carte entre dans le paquet d’une légende si elle est jouée dans au moins ce pourcentage des decks de cette légende.',

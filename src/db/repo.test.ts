...
describe('repo', () => {
  it('review crée un état et un log, countToday distingue nouveau / révision', async () => {
    ...
    // un autre mode ne compte pas
    expect(await countToday('name', now)).toEqual({ newCount: 0, reviewCount: 0 })
  })

  it('export / reset / import restaure la progression', async () => {
